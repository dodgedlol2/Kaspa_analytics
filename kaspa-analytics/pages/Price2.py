...
# Custom CSS - maximized width and styling
st.markdown("""
<style>
    /* Main app styling */
    .stApp { 
    ...
    /* Remove all padding and margins that could limit width */
...
with st.container():
    ...
    # Dropdown controls - simplified to 4 equal columns
    ...
    # Update layout with dollar signs and no y-axis label
    fig.update_layout(
        plot_bgcolor='#1A1D26',
        ...
        hovermode='x unified',
        height=700,
        margin=dict(l=0, r=0, t=60, b=100),  # Zero side margins
        ...
        yaxis=dict(
            ...
            gridwidth=1,
            gridcolor='rgba(255, 255, 255, 0.1)',
            tickprefix="$",  # Add dollar sign to ticks
            tickformat=".3f",  # Format numbers
            linecolor='#3A3C4A',
            zerolinecolor='#3A3C4A'
        ),
        legend=dict(
    ...
    # Display chart - use_container_width should now work properly
