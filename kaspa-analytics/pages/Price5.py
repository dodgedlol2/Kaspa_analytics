...
<style>
    ...
    * {
    ...
    /* Enhanced Control Panel - Now part of chart */
    .chart-section {
...
# Chart Section with integrated controls
st.markdown("""
<div class="chart-section">
    <div class="control-panel">
        <div class="control-header">
            <div>
                <h3 class="control-title">Analysis Configuration</h3>
                <div class="control-subtitle">Customize your market view with precision controls</div>
            </div>
        </div>
    </div>
</div>
...
<div class="chart-content">
    <div class="chart-header">
        <div>
            ...
            <div class="chart-subtitle">Real-time price data with advanced power-law modeling and predictive analytics</div>
        </div>
