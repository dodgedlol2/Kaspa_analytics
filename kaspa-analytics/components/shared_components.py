st.markdown("""
    <style>
        ...
        /* ULTRA-AGGRESSIVE: Deep selectbox styling that overrides Streamlit defaults */
        
        /* Target the selectbox container with maximum specificity */
        ...
        .main .block-container .stSelectbox > div > div > div > div {
        ...
        /* Target the actual input field with data attributes */
        ...
        /* Hover states */
        .main .stSelectbox div[role="button"]:hover,
        div[data-baseweb="select"]:hover > div,
        div[data-baseweb="select"]:hover > div > div,
        div[data-baseweb="select"]:hover > div > div > div {
        ...
        /* Force override using CSS custom properties */
        .main .stSelectbox {
            --select-bg: linear-gradient(135deg, rgba(30, 41, 59, 0.9) 0%, rgba(15, 23, 42, 0.9) 100%);
            --select-border: 2px solid rgba(100, 116, 139, 0.3);
            --select-border-hover: 2px solid #00d4ff;
            --select-text-color: #f1f5f9;
        }
        
        /* Additional ultra-specific targeting */
        .stSelectbox > div > div > div > div > div {
            background: var(--select-bg, linear-gradient(135deg, rgba(30, 41, 59, 0.9) 0%, rgba(15, 23, 42, 0.9) 100%)) !important;
            border: var(--select-border, 2px solid rgba(100, 116, 139, 0.3)) !important;
            border-radius: 12px !important;
            color: var(--select-text-color, #f1f5f9) !important;
        }
        
        /* Use attribute selectors for maximum coverage */
    ...
    <script>
        // JavaScript to force styling on Streamlit selectboxes after they load
        function forceSelectboxStyling() {
            ...
            setTimeout(() => {
                ...
                selectboxes.forEach(selectbox => {
                    ...
                    divs.forEach(div => {
                        ...
                        if (div.getAttribute('role') === 'button' || div.querySelector('[role="button"]')) {
                            div.style.background = 'linear-gradient(135deg, rgba(30, 41, 59, 0.9) 0%, rgba(15, 23, 42, 0.9) 100%)';
                            div.style.border = '2px solid rgba(100, 116, 139, 0.3)';
                            ...
                            div.addEventListener('mouseenter', () => {
                                ...
                                div.style.boxShadow = '0 8px 32px rgba(0, 212, 255, 0.2), 0 0 0 1px rgba(0, 212, 255, 0.3)';
                                div.style.transform = 'translateY(-2px)';
                            });
                            
                            div.addEventListener('mouseleave', () => {
                                div.style.borderColor = 'rgba(100, 116, 139, 0.3)';
                                div.style.boxShadow = '0 4px 16px rgba(0, 0, 0, 0.2)';
                ...
                // Also style any data-baseweb select elements
            ...
            // Also run again after a longer delay to catch late-loading elements
            setTimeout(() => {
                forceSelectboxStyling();
            }, 1000);
        }
